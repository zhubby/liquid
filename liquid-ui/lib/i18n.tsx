...
const zhCN = {
  ...
  restoreHistory: {
    ...
    resetFilters: "重置",
    loading: "正在加载恢复记录",
    loadingDetail: "正在加载恢复详情",
    emptyTitle: "暂无恢复记录",
    emptyDescription: "调整筛选条件，或从备份发起数据库恢复后再查看。",
    totalCount: (count: number) => `${count} 条恢复记录`,
    pageSummary: (page: number, pageCount: number, total: number) =>
      `第 ${page} / ${pageCount} 页，共 ${total} 条`,
    pageSize: "每页",
    previousPage: "上一页",
    nextPage: "下一页",
    allDatabases: "全部目标数据库",
    allStatuses: "全部状态",
    backupIdPlaceholder: "输入备份 ID",
    filters: {
...
const enUS: Messages = {
  ...
  databasePicker: {
    ...
    restoreMenu: "Restores",
    restoreMenuDescription: "Restore records",
  ...
  restoreHistory: {
    ...
    loadFailed: "Failed to load restore records",
    refresh: "Refresh",
    resetFilters: "Reset",
    loading: "Loading restore records",
    loadingDetail: "Loading restore detail",
    emptyTitle: "No restore records",
    emptyDescription:
      "Adjust the filters, or restore a database from a backup first.",
    totalCount: (count: number) =>
      `${count} restore ${count === 1 ? "record" : "records"}`,
    pageSummary: (page: number, pageCount: number, total: number) =>
      `Page ${page} of ${pageCount}, ${total} total`,
    pageSize: "Per page",
    previousPage: "Previous",
    nextPage: "Next",
    allDatabases: "All target databases",
    allStatuses: "All statuses",
    backupIdPlaceholder: "Enter backup ID",
    filters: {
    ...
    detailTitle: "Restore detail",
    closeDetail: "Close restore detail",
    metadata: "Metadata",
    targetSnapshot: "Target database snapshot",
    context: "Context",
    purpose: "Purpose",
    worker: "Worker",
    format: "Format",
