...
pub struct DatabaseBackupListFilters<'a> {
    pub source_managed_database_id: Option<&'a str>,
    pub status: Option<DatabaseBackupStatus>,
    pub trigger: Option<DatabaseBackupTrigger>,
    pub page: i64,
    pub page_size: i64,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct DatabaseBackupListPage {
    pub records: Vec<DatabaseBackupRecord>,
    pub total_count: i64,
    pub page: i64,
    pub page_size: i64,
}
