...
const zhCN = {
  ...
  databasePicker: {
    ...
    backupPlaceholderTitle: "备份功能准备中",
    backupPlaceholderDescription:
      "这里将展示数据库备份与恢复任务。当前版本先保留入口，暂不创建或调用备份任务。",
    backupPlaceholderBadge: "占位",
  },
  auditHistory: {
    title: "审计记录",
    loadFailed: "加载审计记录失败",
...
const enUS: Messages = {
  ...
  databasePicker: {
    ...
    backupMenu: "Backups",
    backupMenuDescription: "Backup placeholder",
    ...
    backupPlaceholderTitle: "Backups are being prepared",
    backupPlaceholderDescription:
      "Database backup and restore jobs will appear here. This version keeps the entry point visible without creating or calling backup tasks.",
    backupPlaceholderBadge: "Placeholder",
  },
  auditHistory: {
    title: "Audit records",
